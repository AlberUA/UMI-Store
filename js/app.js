(() => {
    ...
    function functions_menuClose() {
        ...
        document.documentElement.classList.remove("filter-show");
    }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".socials-home__slider")) new swiper_core_Swiper(".socials-home__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 4.5,
            ...
            mousewheel: {
                enabled: true,
                sensitivity: 1,
                eventsTarget: ".socials-home__slider"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
        ...
        if (document.querySelector(".bestsellers-home__slider")) new swiper_core_Swiper(".bestsellers-home__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".images-hero-product")) {
            const thumbsSwiper = new swiper_core_Swiper(".images-hero-product__thumbs", {
                modules: [ Thumb ],
                observer: true,
                slidesPerView: 5,
                spaceBetween: 14,
            ...
            new swiper_core_Swiper(".images-hero-product__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".recomendations-content-product__slider")) new swiper_core_Swiper(".recomendations-content-product__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            spaceBetween: 6,
        ...
        if (document.querySelector(".awards-producer__slider")) new swiper_core_Swiper(".awards-producer__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".content-single-news__slider")) new swiper_core_Swiper(".content-single-news__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".controls-slider-single-news__button_prev",
                nextEl: ".controls-slider-single-news__button_next"
            },
            on: {}
        });
        if (document.querySelector(".dishes-about-content-product__slider")) new swiper_core_Swiper(".dishes-about-content-product__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.2,
            ...
            watchOverflow: true,
            pagination: {
                el: ".dishes-about-content-product__slider-pagination",
                clickable: true
            },
            breakpoints: {
                320: {
...
***************************************************************************** */
    ...
    da.init();
    const materials = document.querySelectorAll(".slide-socials-home");
    materials.forEach((elem => {
        elem.addEventListener("mouseenter", (function(e) {
            materials.forEach((e => {
                if (e.classList.contains("hover")) e.classList.remove("hover");
            }));
            let target = e.target;
            target.classList.add("hover");
        }));
    }));
    const filterButton = document.querySelector(".controls-content-catalog__filter-menu");
    const filterMenuClose = document.querySelector(".top-filter-catalog__icon");
    const filterMenu = document.querySelector(".filter-catalog");
    if (filterButton && filterMenuClose && filterMenu) {
        filterButton.addEventListener("click", showMenuFilter);
        function showMenuFilter() {
            filterMenu.classList.toggle("_show");
            document.documentElement.classList.add("lock");
            document.documentElement.classList.add("filter-show");
        }
        filterMenuClose.addEventListener("click", hideMenuFilter);
        function hideMenuFilter() {
            filterMenu.classList.remove("_show");
            document.documentElement.classList.remove("lock");
            document.documentElement.classList.remove("filter-show");
        }
    }
    document.addEventListener("click", (function(e) {
        const targetElement = e.target;
        if (targetElement.classList.contains("sort-button-low-rating") || targetElement.classList.contains("sort-button-high-rating")) {
            const reviewsContainer = document.querySelector(".reviews-container");
            const reviewItems = document.querySelectorAll(".reviews-item");
            const sortedFavorites = [ ...reviewItems ].sort(((a, b) => {
                const ratingElementA = a.querySelector(".rating").getAttribute("data-rating-value");
                const ratingElementB = b.querySelector(".rating").getAttribute("data-rating-value");
                const getRating = el => el * 10;
                if (targetElement.classList.contains("sort-button-low-rating")) return getRating(ratingElementA) - getRating(ratingElementB); else if (targetElement.classList.contains("sort-button-high-rating")) return getRating(ratingElementB) - getRating(ratingElementA);
            }));
            reviewsContainer.innerHTML = "";
            sortedFavorites.forEach((el => {
                reviewsContainer.appendChild(el);
            }));
        }
        if (targetElement.classList.contains("sort-button-popular") || targetElement.classList.contains("sort-button-price-up") || targetElement.classList.contains("sort-button-price-down")) {
            const cardsContainer = document.querySelector(".cards-container");
            const cardItems = document.querySelectorAll(".product-card");
            const sortedFavorites = [ ...cardItems ].sort(((a, b) => {
                const priceElementA = a.querySelector(".product-card__price").innerHTML;
                const priceElementB = b.querySelector(".product-card__price").innerHTML;
                const ratingElementA = a.querySelector(".rating").getAttribute("data-rating-value");
                const ratingElementB = b.querySelector(".rating").getAttribute("data-rating-value");
                const getRating = el => el * 10;
                const getPrice = el => el.replace(/[^0-9.]/g, "");
                if (targetElement.classList.contains("sort-button-price-up")) return getPrice(priceElementA) - getPrice(priceElementB); else if (targetElement.classList.contains("sort-button-price-down")) return getPrice(priceElementB) - getPrice(priceElementA); else if (targetElement.classList.contains("sort-button-popular")) return getRating(ratingElementB) - getRating(ratingElementA);
            }));
    ...
    const buttonBox = document.querySelector(".bestsellers-home__button-box");
    if (buttonBox) {
        const buttonTopCoord = buttonBox.offsetTop;
        window.addEventListener("scroll", (function(event) {
            let scrollY = this.scrollY;
            if (scrollY >= buttonTopCoord - parseInt(130)) buttonBox.classList.add("fixed"); else buttonBox.classList.remove("fixed");
        }));
    }
    document.addEventListener("DOMContentLoaded", (function() {
        const yes_btn = document.querySelector("#check-age-yes");
        let isAllowed = localStorage.getItem("isAllowed");
        if (isAllowed !== "yes") modules_flsModules.popup.open("#popup-age");
        yes_btn.addEventListener("click", (function() {
            localStorage.setItem("isAllowed", "yes");
        }));
    }));
    const dateInfoCart = document.querySelector(".details-content-cart__label-date > span");
    if (dateInfoCart) dateInfoCart.addEventListener("click", (function() {
        const dateParent = dateInfoCart.closest(".details-content-cart__item_date");
        dateParent.querySelector(".details-content-cart__label-info").classList.toggle("show");
    }));
    const menuFooterManuals = document.querySelector(".menu-footer__list_3");
    if (menuFooterManuals) menuFooterManuals.setAttribute("data-da", ".menu-footer__column_1, 450, 1");
    const newsHomeItem2 = document.querySelectorAll(".item-news-home")[1];
    const imageNewsHomeItem2 = document.querySelectorAll(".item-news-home__image")[1];
    if (newsHomeItem2) {
        newsHomeItem2.classList.add("item-news-home_center");
        imageNewsHomeItem2.classList.add("item-news-home__image_big");
    }
    const producerCertificateBtn = document.querySelector(".footer-products-producer__button > span");
    if (producerCertificateBtn) if (producerCertificateBtn.innerHTML === "") producerCertificateBtn.closest(".products-producer__footer").classList.add("hide");
    window["FLS"] = true;
    isWebp();
    addTouchClass();
    addLoadedClass();
